...
<template>
  ...
  <section id="d">
    <p>
      Tienes acceso a todas las funcionalidades de los usuarios. A continuacion, te guiaremos por algunas configuracionesclave para empezar a gestionar tus usuarios eficientemente
    </p>
  </section>
  ...
  <div class="progress-container">
    ...
    <div class="progress-container">
        ...
        <button id="A"><a href="/Insert">Agregar Trabajador</a></button>
